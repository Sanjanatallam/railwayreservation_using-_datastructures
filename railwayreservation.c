...
void viewdetails()
{
	...
	printf("-----------------------------------------------------------------------------");
	printf("\n1001\tRed Lines Express\tPune to Nashik\t\tRs.500\t\t9am");
	printf("\n1002\tRed Lines Express\tNashik To Pune\t\tRs.500\t\t12pm");
	printf("\n1003\tNanded City Express\tPune To Nanded\t\tRs.450\t\t8am");
	printf("\n1004\tNanded City Express\tNanded To Pune\t\tRs.450\t\t11am");
	printf("\n1005\tSuperfast Express\tPune To Aurangabad\tRs.600\t\t7am");
	printf("\n1006\tSuperfast Express\tAurangabad To Pune\tRs.650\t\t9.30am");
}
void reservation()
{
	srand(time(0));
